...
{
    partial class PSearchComboBoxEdit
    {
        /// <summary>
        /// 필수 디자이너 변수입니다.
        /// </summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.Properties.Appearance.Font = ControlConfig.DROPDOWNFONT;
            this.Properties.AppearanceDropDown.Font = ControlConfig.DROPDOWNFONT;

            GridView view = this.Properties.View as GridView;

            if (view != null)
            {
                view.Appearance.HeaderPanel.Font = ControlConfig.DROPDOWNFONT;
                view.Appearance.Row.Font = ControlConfig.DROPDOWNFONT;
