...
namespace EBAP.Win.ControlLibrary
{
    /// <summary>
    /// SpinEdit 입니다.
    /// DevExpress SpinEdit를 Wrapping 하여 사용합니다.
    /// </summary>
    /// <remarks>
    /// 2023-02-01 최초생성 : 오인봉
    /// 변경내역
    ...
    /// </remarks>
    [ToolboxItem(true)]
    public partial class PSpinEdit : DevExpress.XtraEditors.SpinEdit, IInitEditValue, ICheckModified, IDBParams, IBindings, IMandatory, IEnterKeySelectEvent, ILocaleCtrl
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        public int DecimalPlace
        {
            ...
            set
            {
                ...
                Properties.DisplayFormat.FormatString = "n" + _decimalPlace;
        ...
        #region :: GetIntegerValue :: 현재 값을 Int 값으로 변환하여 반환합니다.

        /// <summary>
        /// 현재 값을 Int 값으로 변환하여 반환합니다.
        /// </summary>
        /// <returns></returns>
