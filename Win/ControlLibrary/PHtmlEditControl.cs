...
namespace EBAP.Win.ControlLibrary
{
    ...
    /// </remarks>
    [ToolboxItem(true)]
    public partial class PHtmlEditControl : DevExpress.XtraRichEdit.RichEditControl, IInitEditValue, ICheckModified, IDBParams, IBindings
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        /// <summary>
        /// Html 편집기 Control을 생성합니다.
        /// </summary>
        public PHtmlEditControl()
        {
            InitializeComponent();
        }
        ...
        {
            DataBindings.Clear();
            DataBindings.Add("HtmlText", dt, dataMember, false, DataSourceUpdateMode.Never, string.Empty);
        }
