...
namespace EBAP.Win.ControlLibrary
{
    /// <summary>
    /// MemoEdit 입니다.
    /// DevExpress MemoExEdit를 Wrapping 하여 사용합니다.
    /// </summary>
    /// <remarks>
    /// 2023-02-01 최초생성 : 오인봉
    /// 변경내역
    ...
    /// </remarks>
    [ToolboxItem(true)]
    public partial class PMemoExEdit : DevExpress.XtraEditors.MemoExEdit, IInitEditValue, ICheckModified, IDBParams, IBindings, ILocaleCtrl, IMandatory
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        #region :: PMemoExEdit_ParseEditValue :: 개행 문자를 변경합니다.
        ...
        /// <param name="e"></param>
        private void PMemoExEdit_ParseEditValue(object sender, DevExpress.XtraEditors.Controls.ConvertEditValueEventArgs e)
        {
            if (DesignMode) return;
