...
namespace EBAP.Win.UserControlLibrary
{
    ...
    /// </remarks>
    [ToolboxItem(true)]
    public partial class PEmployeeEdit : DevExpress.XtraEditors.XtraUserControl, IEnterKeySelectEvent, ILocaleCtrl, IMandatory, IInitEditValue
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        #region :: UserName :: UserName을 설정합니다.

        /// <summary>
        /// UserName을 설정합니다.
        /// </summary>
        [Category("EBAP"), Browsable(false)]
        [Description("UserName을 설정합니다.")]
        ...
        private void ButtonEdit_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                param.Add("USERID", txtId.EditValue);
                param.Add("USERNAME", "");
            }
            ...
            {
                param.Add("USERID", "");
                param.Add("USERNAME", txtName.EditValue);
            }

            DataRow dr = (FindForm() as IFrameUI).ExecutePopup("User Info", "EBAP.UI.ADM.dll", "EBAP.UI.ADM.Popup.PopUserInfo", param) as DataRow;
            ...
            txtId.EditValue = dr["USERID"];
            txtName.EditValue = dr["USERNAME"];
        }
    }
}
