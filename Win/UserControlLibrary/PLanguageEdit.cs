...
namespace EBAP.Win.UserControlLibrary
{
    ...
    /// </remarks>
    [ToolboxItem(true)]
    public partial class PLanguageEdit : DevExpress.XtraEditors.XtraUserControl, IEnterKeySelectEvent, ILocaleCtrl, IMandatory
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        #region :: Caption :: CAPTION을 설정합니다.

        /// <summary>
        /// CAPTION을 설정합니다.
        /// </summary>
        [Category("EBAP"), Browsable(false)]
        [Description("CAPTION을 설정합니다.")]
        ...
        private void ButtonEdit_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                param.Add("ID", "");
                param.Add("CAPTION", txtName.EditValue);
            }

            DataRow dr = (FindForm() as IFrameUI).ExecutePopup("다국어 정보", "EBAP.UI.ADM.dll", "EBAP.UI.ADM.Popup.PopLanguageMaster", param) as DataRow;
            ...
            txtId.EditValue = dr["ENUMCLASS"];

            switch (culture)
            {
                case "en-US":
                    txtName.EditValue = dr["ENUS"];
                    break;
                default:
                    txtName.EditValue = dr["KOKR"];
                    break;
            }
        }
    }
