...
namespace EBAP.UI.ADM.Popup
{
    ...
    /// </summary>
    public partial class PopSSOUserInfo : EBAP.Win.BaseFrame.PopupFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        private void InitGridControl()
        {
            ...
            viewList.InitColumn("USERID", "ID", 80, 0, false, true);
            viewList.InitColumn("USERNAME", "UserName", 170, 0, false, true);
            viewList.InitColumn("LOGINID", "ID", 130, 0, false, true);
            viewList.InitColumn("DEPTCODE", "DeptCode", 120, 0, false, false);
            viewList.InitColumn("DEPTNAME", "DeptName", 200, 0, false, true);
            viewList.InitColumn("GRADECODE", "GradeCode", 80, 0, false, false);
        ...
        private void SelectionData()
        {
            ...
            const string queryId = @"dbo.SSOUserInfo_Get";
