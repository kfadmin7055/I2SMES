...
{
    #region :: EBAP.UI.ADM.Management.LinkMenu ::
    ...
    ///               2. 
    /// History     :
    ///               1. (2022-01-21 오전 8:50:00 - user - DESKTOP-7JQVRP4) : 최초 생성
    ///               2.
    ///               3.
    /// </remarks>
    public partial class LinkMenu : EBAP.Win.BaseFrame.UIFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        #region :: LinkMenu_Load :: Form이 Load 시 발생합니다.
        ...
        private void InitGridControl()
        {
            ...
            viewList.InitColumn("MENUID", "MenuId", 80, 0, false, true, DataType.Default, HorzAlign.Default);
            viewList.InitColumn("MENUNAME", "MenuName", 200, 0, true, true, DataType.Default, HorzAlign.Default);
            viewList.InitColumn("LVL", "Level", 60, 0, false, false);
            viewList.InitColumn("IDX", "IDX", 60, 0, true, true, DataType.Number, HorzAlign.Far);
            viewList.InitColumn("LINKURL", "URL", 500, 0, true, true, DataType.Default, HorzAlign.Default);
            viewList.InitColumn("DESCRIPTION", "Description", 180, 0, true, true, DataType.Default, HorzAlign.Default);
            viewList.InitColumn("USEFLAG", "UseFlag", 60, 0, true, true, DataType.CheckEdit, HorzAlign.Center);
            viewList.InitColumn("LINKTYPE", "Link 구분", 90, 0, true, true, DataType.Default, HorzAlign.Default);
            viewList.InitColumn("ISBEGINGROUP", "Begin Group", 80, 0, true, true, DataType.CheckEdit, HorzAlign.Center);
            ...
            viewList.InitComboBoxColumn("LINKTYPE", AppCode.GetCodeMaster("C$LINKTYPE", ""));
            viewList.NewRowEnableColumns = new string[] { "MENUID" };
            viewList.MandatoryColumns = new string[] { "MENUID", "MENUNAME" };

            viewList.SetColumnCharacterCasing(CharacterCasing.Upper, "MENUID");
        ...
        #region :: LinkMenu_Link :: Form 간 Data 전송 시 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LinkMenu_Link(object sender, EventArgs e)
        {
            try
            {
                LinkData();
        ...
        #region :: LinkMenu_Selection :: MainForm의 조회 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LinkMenu_Selection(object sender, EventArgs e)
        {
            try
            {
                SetFormLayout();
        ...
        private void SelectionData()
        {
            ...
            const string queryId = @"dbo.LinkMenu_Select";
        ...
        #region :: LinkMenu_New :: MainForm의 신규 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LinkMenu_New(object sender, EventArgs e)
        {
            try
            {
                NewData();
        ...
        {
            //viewList.AddNewRow();
            viewList.AddNewRow("MENUID");
        }

        #endregion

        #region :: LinkMenu_Save :: MainForm의 저장 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LinkMenu_Save(object sender, EventArgs e)
        {
            try
            {
                SaveData();
        ...
        {
            const string queryId = @"dbo.LinkMenu_Save";
        ...
        #region :: LinkMenu_Delete :: MainForm의 삭제 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LinkMenu_Delete(object sender, EventArgs e)
        {
            try
            {
                DeleteData();
        ...
        {
            const string queryId = @"dbo.LinkMenu_Delete";
        ...
        private void viewList_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            try
            {
                viewList.SetRowCellValue(e.RowHandle, "MENUID", "");
                viewList.SetRowCellValue(e.RowHandle, "MENUNAME", "");
                viewList.SetRowCellValue(e.RowHandle, "LVL", "0");
                viewList.SetRowCellValue(e.RowHandle, "LINKTYPE", "W");
                viewList.SetRowCellValue(e.RowHandle, "USEFLAG", true);
                viewList.SetRowCellValue(e.RowHandle, "ISBEGINGROUP", false);
            }
            catch (Exception ex)
            {
                ShowExceptionBox(ex);
