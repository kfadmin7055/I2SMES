...
{
    #region :: EBAP.UI.ADM.Management.QueryExecute ::
    ...
    ///               3.
    /// </remarks>
    public partial class QueryExecute : EBAP.Win.BaseFrame.UIFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        #region :: QueryExecute_Load :: Form이 Load 시 발생합니다.
        ...
        /// <param name="e"></param>
        private void QueryExecute_Load(object sender, EventArgs e)
        {
            try
            {
                InitLocalization();
        ...
        {
            cboDatabase.InitData(AppCode.GetCodeMaster("C$DBID", ""));
        }
        ...
        #region :: QueryExecute_Link :: Form 간 Data 전송 시 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void QueryExecute_Link(object sender, EventArgs e)
        {
            try
            {
                LinkData();
        ...
        #region :: QueryExecute_Selection :: MainForm의 조회 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void QueryExecute_Selection(object sender, EventArgs e)
        {
            try
            {
                SetFormLayout();
        ...
        #region :: QueryExecute_New :: MainForm의 신규 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void QueryExecute_New(object sender, EventArgs e)
        {
            try
            {
                NewData();
        ...
        #region :: QueryExecute_Save :: MainForm의 저장 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void QueryExecute_Save(object sender, EventArgs e)
        {
            try
            {
                SaveData();
        ...
        #region :: QueryExecute_Delete :: MainForm의 삭제 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void QueryExecute_Delete(object sender, EventArgs e)
        {
            try
            {
                DeleteData();
        ...
        private void btnExecute_Click(object sender, EventArgs e)
        {
            try
            {
                btnExecute.IsValid = CheckExecuteCondition();

                if (!btnExecute.IsValid) return;
        ...
        {
            return ShowMsgBox(String.Format("[ {0} ] DB에 쿼리를 실행 하시겠습니까?", cboDatabase.GetDisplayText()), "Upload 확인", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes ? true : false;
        }

        private void ExecuteQuery()
        {
            string queryId = txtQuery.EditValue.ToString();
            ...
            using (SqlBiz wb = new SqlBiz(AppConfig.WEBSERVICEURL))
            {
                wb.Tx_ExecuteNonQuery(cboDatabase.EditText, queryId, AppConfig.COMMANDTEXT, paramList, valueList);
            }
        }
