...
{
    #region :: EBAP.UI.ADM.Management.LocaleMaster ::
    ...
    ///               3.
    /// </remarks>
    public partial class LocaleMaster : EBAP.Win.BaseFrame.UIFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        #region :: LocaleMaster_Load :: Form이 Load 시 발생합니다.
        ...
        /// <param name="e"></param>
        private void LocaleMaster_Load(object sender, EventArgs e)
        {
            try
            {
                InitLocalization();
        ...
        private void InitGridControl()
        {
            ...
            viewList.InitColumn("KOKR", "한국어", 120, 0, true, true);
            viewList.InitColumn("ENUS", "English", 120, 0, true, true);
            viewList.InitColumn("ZHCHS", "中國語", 120, 0, true, true);
            ...
            viewList.SetAutoInsertColumn("STRINGID");
        ...
        #region :: LocaleMaster_Link :: Form 간 Data 전송 시 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LocaleMaster_Link(object sender, EventArgs e)
        {
            try
            {
                LinkData();
        ...
        #region :: LocaleMaster_Selection :: MainForm의 조회 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LocaleMaster_Selection(object sender, EventArgs e)
        {
            try
            {
                SetFormLayout();
        ...
        {
            DataSet ds;
            string queryId = @"dbo.LocaleMaster_Select";
        ...
        #region :: LocaleMaster_New :: MainForm의 신규 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LocaleMaster_New(object sender, EventArgs e)
        {
            try
            {
                NewData();
        ...
        #region :: LocaleMaster_Save :: MainForm의 저장 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LocaleMaster_Save(object sender, EventArgs e)
        {
            try
            {
                SaveData();
        ...
        {
            const string queryId = @"dbo.LocaleMaster_Save";
        ...
        #region :: LocaleMaster_Delete :: MainForm의 삭제 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LocaleMaster_Delete(object sender, EventArgs e)
        {
            try
            {
                DeleteData();
        ...
        {
            const string queryId = @"dbo.LocaleMaster_Delete";

            string[] paramList = new string[] { "@STRINGID" };
        ...
        private void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            foreach (DataRow dr in drs)
            {
                ...
                sb.AppendLine("/// </summary>");
                sb.AppendLine(string.Format("{0} = {1},", dr["ENUMCLASS"], dr["STRINGID"]));
            }
