...
{
    #region :: EBAP.UI.ADM.Management.FTPInfo ::
    ...
    ///               2. 
    /// History     :
    ///               1. (2018-04-11 오전 11:31:55 - 오인봉 - PC170245) : 최초 생성
    ///               2.
    ///               3.
    /// </remarks>
    public partial class FTPInfo : EBAP.Win.BaseFrame.UIFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        #region :: FTPInfo_Load :: Form이 Load 시 발생합니다.
        ...
        /// <param name="e"></param>
        private void FTPInfo_Load(object sender, EventArgs e)
        {
            try
            {
                InitLocalization();
        ...
        private void InitGridControl()
        {
            ...
            viewList.InitColumn("FTPID", "FTP ID", 120, 0, false, true, DataType.Default, HorzAlign.Default);
            viewList.InitColumn("FTPSERVERPATH", "서버 URL", 180, 0, SaveAuth, true, DataType.Default, HorzAlign.Default);
            viewList.InitColumn("FTPPORT", "서버 Port", 60, 0, SaveAuth, true, DataType.Default, HorzAlign.Center);
            viewList.InitColumn("FTPUSERID", "사용자 ID", 120, 0, SaveAuth, true, DataType.Default, HorzAlign.Default);
            viewList.InitColumn("FTPPWD", "비밀번호", 120, 0, SaveAuth, true, DataType.Password, HorzAlign.Default);
            viewList.InitColumn("LIMITSIZE", "제한크기(byte)", 90, 0, SaveAuth, true, DataType.Number, HorzAlign.Far);
            viewList.InitColumn("DIRECTORYPATH", "FTP 디렉터리", 250, 0, SaveAuth, true, DataType.Default, HorzAlign.Default);
            ...
            viewList.SetColumnCharacterCasing(CharacterCasing.Upper, "FTPID");

            viewList.MandatoryColumns = new string[] { "FTPID", "FTPSERVERPATH", "FTPPORT", "FTPUSERID", "FTPPWD", "LIMITSIZE" };
            viewList.NewRowEnableColumns = new string[] { "FTPID" };
            viewList.NewRowCopyColumns = new string[] { "FTPSERVERPATH", "FTPPORT", "FTPUSERID", "FTPPWD", "LIMITSIZE" };
        ...
        #region :: FTPInfo_Link :: Form 간 Data 전송 시 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FTPInfo_Link(object sender, EventArgs e)
        {
            try
            {
                LinkData();
        ...
        #region :: FTPInfo_Selection :: MainForm의 조회 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FTPInfo_Selection(object sender, EventArgs e)
        {
            try
            {
                SetFormLayout();
        ...
        {
            DataSet ds;
            const string queryId = @"dbo.FtpInfo_Select";
        ...
        #region :: FTPInfo_New :: MainForm의 신규 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FTPInfo_New(object sender, EventArgs e)
        {
            try
            {
                NewData();
        ...
        {
            viewList.AddNewRow("FTPID");
        }

        #endregion

        #region :: FTPInfo_Save :: MainForm의 저장 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FTPInfo_Save(object sender, EventArgs e)
        {
            try
            {
                SaveData();
        ...
        {
            const string queryId = @"dbo.FtpInfo_Save";

            string[] paramList = new string[] { "@FTPID",
                                                "@FTPSERVERPATH",
                                                "@FTPPORT",
                                                "@FTPUSERID",
                                                "@FTPPWD",
        ...
        #region :: FTPInfo_Delete :: MainForm의 삭제 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void FTPInfo_Delete(object sender, EventArgs e)
        {
            try
            {
                DeleteData();
        ...
        {
            const string queryId = @"dbo.FtpInfo_Delete";
