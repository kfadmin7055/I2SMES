...
{
    #region :: EBAP.UI.ADM.Management.LocaleMessageMaster ::
    ...
    ///               2. 
    /// History     :
    ///               1. (2018-04-11 오전 11:47:42 - 오인봉 - PC170245) : 최초 생성
    ///               2.
    ///               3.
    /// </remarks>
    public partial class LocaleMessageMaster : EBAP.Win.BaseFrame.UIFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        /// <summary>
        /// LocaleMessageMaster Form을 생성합니다.
        /// </summary>
        public LocaleMessageMaster()
        {
            InitializeComponent();
        ...
        #region :: LocaleMessageMaster_Load :: Form이 Load 시 발생합니다.
        ...
        /// <param name="e"></param>
        private void LocaleMessageMaster_Load(object sender, EventArgs e)
        {
            try
            {
                InitLocalization();
        ...
        private void InitGridControl()
        {
            ...
            viewList.InitColumn("MESSAGEID", "ID", 80, 0, false, true, DataType.Default, HorzAlign.Center);
            viewList.InitColumn("KOKR", "한국어", 250, 0, true, true);
            viewList.InitColumn("ENUS", "English", 250, 0, true, true);
            viewList.InitColumn("ZHCHS", "中國語", 250, 0, true, true);
            viewList.InitColumn("ENUMCLASS", "C# Enum Class", 120, 0, true, true);
            viewList.InitColumn("ISEXPORT", "XML 배포", 80, 0, true, true, DataType.CheckEdit);
            viewList.InitColumn("CHANGEBY", "등록자", 80, 0, false, false);
            viewList.InitColumn("CHANGEDTTM", "변경일시", 130, 0, false, false, DataType.DateTime, HorzAlign.Center);

            viewList.MandatoryColumns = new string[] { "KOKR", "ENUMCLASS", "ISEXPORT" };
            viewList.KeyColumns = new string[] { "ENUMCLASS" };
            viewList.SetAutoInsertColumn("MESSAGEID");
        ...
        #region :: LocaleMessageMaster_Link :: Form 간 Data 전송 시 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LocaleMessageMaster_Link(object sender, EventArgs e)
        {
            try
            {
                LinkData();
        ...
        #region :: LocaleMessageMaster_Selection :: MainForm의 조회 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LocaleMessageMaster_Selection(object sender, EventArgs e)
        {
            try
            {
                SetFormLayout();
        ...
        {
            DataSet ds;
            string queryId = @"dbo.LocaleMessageMaster_Select";
        ...
        #region :: LocaleMessageMaster_New :: MainForm의 신규 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LocaleMessageMaster_New(object sender, EventArgs e)
        {
            try
            {
                NewData();
        ...
        {
            viewList.AddNewRow("KOKR");
        }

        #endregion

        #region :: LocaleMessageMaster_Save :: MainForm의 저장 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LocaleMessageMaster_Save(object sender, EventArgs e)
        {
            try
            {
                SaveData();
        ...
        {
            const string queryId = @"dbo.LocaleMessageMaster_Save";

            string[] paramList = new string[] { "@KOKR",
                                                "@ENUS",
                                                "@ZHCHS",
                                                "@ENUMCLASS",
                                                "@ISEXPORT",
        ...
        #region :: LocaleMessageMaster_Delete :: MainForm의 삭제 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void LocaleMessageMaster_Delete(object sender, EventArgs e)
        {
            try
            {
                DeleteData();
        ...
        {
            const string queryId = @"dbo.LocaleMessageMaster_Delete";

            string[] paramList = new string[] { "@MESSAGEID" };
        ...
        #region :: btnCreate_Click :: C# Enum Class를 생성합니다.
        ...
        {
            DataRow[] drs = viewList.GetDataTableByDataSource().Select("ISEXPORT = 1");
            ...
            {
                sb.AppendLine("/// <summary>");
                sb.AppendLine(string.Format("/// {0}", dr["KOKR"]));
                sb.AppendLine("/// </summary>");
                sb.AppendLine(string.Format("{0} = {1},", dr["ENUMCLASS"], dr["MESSAGEID"]));
            }
            txtEnumClass.EditValue = sb;
        }

        #endregion

        #region :: btnSelectAll_Click :: 생성된 Enum Class 를 ClipBoard에 복사합니다.

        /// <summary>
        /// 생성된 Enum Class 를 ClipBoard에 복사합니다.
        /// </summary>
        /// <param name="sender"></param>
        /// <param name="e"></param>
        ...
        {
            txtEnumClass.Focus();
            txtEnumClass.SelectAll();

            Clipboard.SetText(txtEnumClass.SelectedText);
        }
        ...
        private void viewList_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            try
            {
                viewList.SetRowCellValue(e.RowHandle, "ENUS", "");
                viewList.SetRowCellValue(e.RowHandle, "ZHCHS", "");
                viewList.SetRowCellValue(e.RowHandle, "ISEXPORT", true);
            }
            catch (Exception ex)
            {
                ShowExceptionBox(ex);
