...
{
    #region :: EBAP.UI.ADM.Management.DeployHistory ::
    ...
    ///               3.
    /// </remarks>
    public partial class DeployHistory : EBAP.Win.BaseFrame.UIFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        #region :: DeployHistory_Load :: Form이 Load 시 발생합니다.
        ...
        /// <param name="e"></param>
        private void DeployHistory_Load(object sender, EventArgs e)
        {
            try
            {
                InitLocalization();
        ...
        private void InitGridControl()
        {
            ...
            viewList.InitColumn("ASSEMBLYID", "ID", 90, 0, false, true, DataType.Default, HorzAlign.Center);
            viewList.InitColumn("ASSEMBLYNAME", "FileName", 250, 0, false, true);
            viewList.InitColumn("SIZE", "파일크기", 100, 0, false, true, DataType.Default, HorzAlign.Far);
            viewList.InitColumn("VERSION", "Version", 120, 0, false, true);
            viewList.InitColumn("REASON", "Description2", 500, 0, false, true);
            viewList.InitColumn("ISESSENTIAL", "필수항목", 60, 0, false, true, DataType.CheckEdit);
            ...
            //viewList.InitComboBoxColumn("ASSEMBLYID", new object[] { "ASM0001", "ASM0002" }, new string[] { "AAAAAAAAAAAAAAA", "BBBBBBBBBBBBBBB" });

            viewList.SetCellMerge("ASSEMBLYID", "ASSEMBLYNAME");

            viewList.SetGroupSummary("VERSION", SummaryType.Max);
            viewList.SetGroupSummary("REASON", SummaryType.Count);
        ...
        {
            cboAssemblyId.InitData(AppCode.GetAssemblyID());
        }
        ...
        #region :: DeployHistory_Link :: Form 간 Data 전송 시 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DeployHistory_Link(object sender, EventArgs e)
        {
            try
            {
                LinkData();
        ...
        {
            cboAssemblyId.EditValue = LinkParams["ASSEMBLYID"];
        }

        #endregion

        #region :: DeployHistory_Selection :: MainForm의 조회 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DeployHistory_Selection(object sender, EventArgs e)
        {
            try
            {
                SetFormLayout();
        ...
        private void SelectionData()
        {
            ...
            const string queryId = @"dbo.AssemblyDeployHistory_Select";
        ...
        #region :: DeployHistory_New :: MainForm의 신규 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DeployHistory_New(object sender, EventArgs e)
        {
            try
            {
                NewData();
        ...
        #region :: DeployHistory_Save :: MainForm의 저장 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DeployHistory_Save(object sender, EventArgs e)
        {
            try
            {
                SaveData();
        ...
        #region :: DeployHistory_Delete :: MainForm의 삭제 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DeployHistory_Delete(object sender, EventArgs e)
        {
            try
            {
                DeleteData();
