...
{
    #region :: EBAP.UI.ADM.Management.HtmlContentsMaster ::
    ...
    ///               2. 
    /// History     :
    ///               1. (2018-04-11 오전 11:37:19 - 오인봉 - PC170245) : 최초 생성
    ///               2.
    ///               3.
    /// </remarks>
    public partial class HtmlContentsMaster : EBAP.Win.BaseFrame.UIFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        /// <summary>
        /// HtmlContentsMaster Form을 생성합니다.
        /// </summary>
        ...
        #region :: HtmlContentsMaster_Load :: Form이 Load 시 발생합니다.
        ...
        /// <param name="e"></param>
        private void HtmlContentsMaster_Load(object sender, EventArgs e)
        {
            try
            {
                InitLocalization();
        ...
        private void InitGridControl()
        {
            ...
            viewList.InitColumn("HTMLID", "Html ID", 90, 0, false, true);
            viewList.InitColumn("GBN", "구분", 80, 0, true, true, DataType.ComboBox);
            viewList.InitColumn("CONTENTS", "Contents", 250, 0, true, true, DataType.MemoEx);
            ...
            viewList.InitComboBoxColumn("GBN", AppCode.GetCodeMaster("C$HTMLGUBUN", ""));

            viewList.NewRowEnableColumns = new string[] { "HTMLID" };
        ...
        {
            cboGubun.InitData(AppCode.GetCodeMaster("C$HTMLGUBUN", ""));
        }
        ...
        #region :: HtmlContentsMaster_Link :: Form 간 Data 전송 시 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void HtmlContentsMaster_Link(object sender, EventArgs e)
        {
            try
            {
                LinkData();
        ...
        #region :: HtmlContentsMaster_Selection :: MainForm의 조회 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void HtmlContentsMaster_Selection(object sender, EventArgs e)
        {
            try
            {
                SetFormLayout();
        ...
        {
            DataSet ds;
            const string queryId = @"dbo.HtmlContentsMaster_Select";
        ...
        private void InitDataBindings(DataSet ds)
        {
            ...
            txtPreview.BindingMapping(dt, "CONTENTS");
        }

        #endregion

        #region :: HtmlContentsMaster_New :: MainForm의 신규 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void HtmlContentsMaster_New(object sender, EventArgs e)
        {
            try
            {
                NewData();
        ...
        {
            viewList.AddNewRow("HTMLID");
        }

        #endregion

        #region :: HtmlContentsMaster_Save :: MainForm의 저장 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void HtmlContentsMaster_Save(object sender, EventArgs e)
        {
            try
            {
                SaveData();
        ...
        {
            const string queryId = @"dbo.HtmlContentsMaster_Save";
        ...
        #region :: HtmlContentsMaster_Delete :: MainForm의 삭제 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void HtmlContentsMaster_Delete(object sender, EventArgs e)
        {
            try
            {
                DeleteData();
        ...
        {
            const string queryId = @"dbo.HtmlContentsMaster_Delete";
        ...
        private void viewList_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            try
            {
                viewList.SetRowCellValue(e.RowHandle, "HTMLID", "");
                viewList.SetRowCellValue(e.RowHandle, "GBN", "A");
                viewList.SetRowCellValue(e.RowHandle, "CONTENTS", "");
            }
            catch (Exception ex)
            {
                ShowExceptionBox(ex);
