...
{
    #region :: EBAP.UI.ADM.Management.CodeMasterVendor ::
    ...
    ///               3.
    /// </remarks>
    public partial class CodeMasterVendor : EBAP.Win.BaseFrame.UIFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        #region :: CodeMasterVendor_Load :: Form이 Load 시 발생합니다.
        ...
        /// <param name="e"></param>
        private void CodeMasterVendor_Load(object sender, EventArgs e)
        {
            try
            {
                InitLocalization();
        ...
        private void InitDatabaseConnection()
        {
            ...
            if (MENUID.Contains("ABC"))
            {
                DATABASE = ConnectionString.METADB;
                Text = $"{commonCodeMgmt} (매장관리)";
            }
            else
            {
                DATABASE = ConnectionString.METADB;
        ...
        private void InitViewMaster()
        {
            ...
            viewMaster.InitColumn("VENDORCODE", "Vendor", 150, 0, false, false);
            viewMaster.InitColumn("PLANTCODE", "Plant", 200, 0, false, false);
        ...
        private void InitViewDetail()
        {
            ...
            viewDetail.InitColumn("VENDORCODE", "Vendor", 150, 0, false, false);
            viewDetail.InitColumn("PLANTCODE", "Plant", 200, 0, false, false);
            ...
            viewDetail.InitColumn("CHANGEDTTM", "ChangeDttm", 150, 0, false, false, DataType.DateTime);

            viewDetail.NewRowEnableColumns = new string[] { "CODEVALUE" };
            viewDetail.MandatoryColumns = new string[] { "CODEVALUE", "DISPLAYVALUE" };
            viewDetail.KeyColumns = new string[] { "VENDORCODE", "PLANTCODE", "PCODEVALUE", "CODEVALUE" };
        ...
        #region :: CodeMasterVendor_Link :: Form 간 Data 전송 시 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CodeMasterVendor_Link(object sender, EventArgs e)
        {
            try
            {
                LinkData();
        ...
        #region :: CodeMasterVendor_Selection :: MainForm의 조회 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CodeMasterVendor_Selection(object sender, EventArgs e)
        {
            try
            {
                SetFormLayout();
        ...
        private void SelectionData()
        {
            ...
            const string queryId = @"dbo.CodeMaster_Select";

            string[] paramList = new string[] { "@VENDORCODE", "@PLANTCODE", "@DISPLAYVALUE" };

            object[] valueList = new object[] { CurrentUser.VENDORCODE, CurrentUser.PLANTCODE, txtDisplayValue.EditValue };
        ...
        #region :: CodeMasterVendor_New :: MainForm의 신규 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CodeMasterVendor_New(object sender, EventArgs e)
        {
            try
            {
                NewData();
        ...
        #region :: CodeMasterVendor_Save :: MainForm의 저장 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CodeMasterVendor_Save(object sender, EventArgs e)
        {
            try
            {
                SaveData();
        ...
        #region :: CodeMasterVendor_Delete :: MainForm의 삭제 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void CodeMasterVendor_Delete(object sender, EventArgs e)
        {
            try
            {
                DeleteData();
        ...
        private void viewList_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            try
            {
                ...
                {
                    viewMaster.SetRowCellValue(e.RowHandle, "VENDORCODE", CurrentUser.VENDORCODE);
                    viewMaster.SetRowCellValue(e.RowHandle, "PLANTCODE", CurrentUser.PLANTCODE);
                ...
                {
                    viewDetail.SetRowCellValue(e.RowHandle, "VENDORCODE", CurrentUser.VENDORCODE);
                    viewDetail.SetRowCellValue(e.RowHandle, "PLANTCODE", CurrentUser.PLANTCODE);
