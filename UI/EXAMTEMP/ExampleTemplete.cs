#region 어셈블리 EXAMTEMP, v3.24
// C:\EBAP-CORE.NET\EXAMTEMP.dll
...
{
    #region :: EBAP.UI.EXAMTEMP.ExampleTemplete ::
    ...
    ///               2. 
    /// History     :
    ///               1. (2024-12-27 오후 5:04:09 - easto - KFES) : 최초 생성
    ///               2.
    ///               3.
    /// </remarks>
    public partial class ExampleTemplete : EBAP.Win.BaseFrame.UIFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        /// <summary>
        /// ExampleTemplete Form을 생성합니다.
        /// </summary>
        public ExampleTemplete()
        {
            InitializeComponent();
        }
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////
        // Event Handler(ExampleTemplete Common Event)
        ///////////////////////////////////////////////////////////////////////////////////////////////

        #region :: ExampleTemplete_Load :: Form이 Load 시 발생합니다.
        ...
        /// <param name="e"></param>
        private void ExampleTemplete_Load(object sender, EventArgs e)
        {
            try
            {
                InitLocalization();
        ...
        private void InitGridControl()
        {
            ...
            viewList.InitComboBoxColumn("SMALL_NUM", AppCode.GetCodeMaster("Small_Num", ""));

            viewList.InitCheckEditColumn("USEFLAG", "Y", "N");
        ...
        {
            cboSmall_Num.InitData(AppCode.GetCodeMaster("Small_Num", ""));
        }
        ...
        #region :: ExampleTemplete_Link :: Form 간 Data 전송 시 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ExampleTemplete_Link(object sender, EventArgs e)
        {
            try
            {
                LinkData();
        ...
        #region :: ExampleTemplete_Selection :: MainForm의 조회 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ExampleTemplete_Selection(object sender, EventArgs e)
        {
            try
            {
                SetFormLayout();
        ...
        private void SelectionData()
        {
            ...
            string queryId = Q_EXAMTEMP.SelectQuery("ExampleTemplete_Selection");
            ...
            using (OraBiz_CS wb = new OraBiz_CS())
            {
                ...
                ds = wb.NTx_ExecuteDataSet(ConnectionString.ORAMETADB, queryId, AppConfig.COMMANDTEXT, DatabaseParams);
            }
        ...
        #region :: ExampleTemplete_New :: MainForm의 신규 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ExampleTemplete_New(object sender, EventArgs e)
        {
            try
            {
                NewData();
        ...
        #region :: ExampleTemplete_Save :: MainForm의 저장 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ExampleTemplete_Save(object sender, EventArgs e)
        {
            try
            {
                SaveData();
        ...
        {
            string[] queryId = new string[] { Q_EXAMTEMP.Merge() };
            ...
            using (OraBiz_CS wb = new OraBiz_CS())
            {
                ...
                wb.Tx_ExecuteNonQuery(ConnectionString.METADB, queryId, AppConfig.COMMANDTEXT, paramList, viewList.GetAddedModifedData());
            }
        }

        #endregion

        #region :: ExampleTemplete_Delete :: MainForm의 삭제 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void ExampleTemplete_Delete(object sender, EventArgs e)
        {
            try
            {
                DeleteData();
        ...
        {
            string[] queryId = new string[] { Q_EXAMTEMP.Delete() };

            string[] paramList = new string[] { "ID" };

            using (OraBiz_CS wb = new OraBiz_CS())
            {
                wb.Tx_ExecuteNonQuery(ConnectionString.METADB, queryId, AppConfig.COMMANDTEXT, paramList, viewList.GetCheckedData());
            }
        }
