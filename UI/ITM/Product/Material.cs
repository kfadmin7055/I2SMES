#region 어셈블리 EBAP.UI.ITM.Material, v3.24
// C:\EBAP-CORE.NET\EBAP.UI.ITM.Material.dll
...
{
    #region :: EBAP.UI.ITM.Product.Material ::
    ...
    ///               3.
    /// </remarks>
    public partial class Material : EBAP.Win.BaseFrame.UIFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        {
            this.Save -= Material_Save;
            this.Save += Material_Save;

            this.Delete -= Material_Delete;
            this.Delete += Material_Delete;

            this.New -= Material_New;
            this.New += Material_New;
        ...
        private void InitGridControl()
        {
            ...
            viewList.InitColumn("MATERIAL_TYPE", "MaterialType", 75, 1, true, true, DataType.ComboBox, HorzAlign.Default);
            viewList.InitColumn("MATERIAL_CODE", "MaterialCode", 110, 10, false, true, DataType.Default, HorzAlign.Default);
            viewList.InitColumn("MATERIAL_NAME", "MaterialName", 220, 50, true, true, DataType.Default, HorzAlign.Default);
            viewList.InitColumn("WEIGHING_TYPE", "WeighingType", 100, 5, true, true, DataType.ComboBox, HorzAlign.Default);
            viewList.InitColumn("REMARKS", "Remark", 200, 11, true, true, DataType.Default, HorzAlign.Default);
            ...
            viewList.InitComboBoxColumn("MATERIAL_TYPE", AppCode.GetMESCommonCode(this.GetType().FullName, "MaterialType"));

            viewList.InitComboBoxColumn("WEIGHING_TYPE", AppCode.GetMESCommonCode(this.GetType().FullName, "WeighingType"));

            viewList.NewRowEnableColumns = new string[] { "MATERIAL_CODE" };
        ...
        private void SelectionData()
        {
            ...
            string queryId = Q_MATERIAL.SelectQuery("reference");
            ...
            object[] valueList = new object[] { CurrentUser.PLANTCODE
                                                , cboMaterialType.EditValue
                                                , txtMaterialCode.EditValue
                                                , txtMaterialName.EditValue
                                                };
        ...
        private void SaveData()
        {
            ...
            queryId = new string[] { Q_MATERIAL.Merge() };
        ...
        private void DeleteData()
        {
            ...
            queryId = new string[] { Q_MATERIAL.Delete() };
