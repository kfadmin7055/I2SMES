#region 어셈블리 EBAP.UI.BSE.Disp, v3.24
// C:\EBAP-CORE.NET\EBAP.UI.BSE.Disp.dll
...
{
    #region :: EBAP.UI.BSE.Disp.frm_Vehicle ::
    ...
    ///               2. 
    /// History     :
    ///               1. (2026-05-08 오후 4:30:21 - easto - KFES) : 최초 생성
    ///               2.
    ///               3.
    /// </remarks>
    public partial class frm_Vehicle : EBAP.Win.BaseFrame.UIFrame
    {
        ///////////////////////////////////////////////////////////////////////////////////////////////
        ...
        ///////////////////////////////////////////////////////////////////////////////////////////////
        // Event Handler(frm_Vehicle Common Event)
        ///////////////////////////////////////////////////////////////////////////////////////////////

        #region :: frm_Vehicle_Load :: Form이 Load 시 발생합니다.
        ...
        private void InitGridControl()
        {
            ...
            viewList.InitColumn("CAR_CODE", "CarCode", 100, 10, false, true, DataType.Default, HorzAlign.Default);
            viewList.InitColumn("CAR_NO_REAL", "CarNo", 100, 10, false, true, DataType.Default, HorzAlign.Default);
        ...
        #region :: frm_Vehicle_Link :: Form 간 Data 전송 시 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_Vehicle_Link(object sender, EventArgs e)
        {
            try
            {
                LinkData();
        ...
        #region :: frm_Vehicle_Selection :: MainForm의 조회 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_Vehicle_Selection(object sender, EventArgs e)
        {
            try
            {
                SetFormLayout();
        ...
        private void SelectionData()
        {
            ...
            string queryId = Q_CAR_MASTER.SelectQuery("reference");

            string[] paramList = new string[] { "CAR_NO_REAL"
                                                , "USER_NAME"
                                                };

            object[] valueList = new object[] { txtCarNum.EditValue
                                                , txtCarNum.EditValue
                                                };
        ...
        #region :: frm_Vehicle_New :: MainForm의 신규 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_Vehicle_New(object sender, EventArgs e)
        {
            try
            {
                NewData();
        ...
        #region :: frm_Vehicle_Save :: MainForm의 저장 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_Vehicle_Save(object sender, EventArgs e)
        {
            try
            {
                SaveData();
        ...
        private void SaveData()
        {
            ...
            queryId = new string[] { Q_CAR_MASTER.Merge() };
        ...
        #region :: frm_Vehicle_Delete :: MainForm의 삭제 Button을 Click 하면 발생합니다.
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void frm_Vehicle_Delete(object sender, EventArgs e)
        {
            try
            {
                DeleteData();
        ...
        private void DeleteData()
        {
            ...
            string[] paramList = new string[] { ":CAR_CODE" };

            queryId = new string[] { Q_CAR_MASTER.Delete() };
